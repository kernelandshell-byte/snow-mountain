...
//
// Session Buddy had a million users and lost years of their saved sessions in
// a silent Web SQL to IndexedDB migration. That is the failure this file
// exists to make impossible, so the policy from ARCHITECTURE.md is code here
