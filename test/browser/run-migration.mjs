...
// That is exactly why it exists. Session Buddy lost a million people's saved
// sessions in a silent storage migration, and the day a second version is
// needed is a bad day to find out whether any of the policy works. The
