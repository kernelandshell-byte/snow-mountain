...
// The guard is a pause, not an amnesty. Once the sweep has a recent record of
// itself, the retention limit applies exactly as configured.
...
check('the age limit applies again on the next ordinary sweep',
...
check('the popup says the archive could not be opened',
  /could not be opened|cannot be opened|not available/i.test(popupText),
...
check('settings says so too rather than going quiet',
  /could not be opened|cannot be opened|not available/i.test(settingsText),
