...
// The articles are served from 127.0.0.1, which the local network bundle
// rightly skips, so this person unticks it, as anyone testing locally would.
await setup.uncheck('[data-preset="intranet"]');
await setup.click('section[data-step="2"] [data-next]');
await setup.click('section[data-step="3"] [data-next]');
